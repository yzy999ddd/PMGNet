...
def get_training_rain_data(rgb_dir, img_options):
    assert os.path.exists(rgb_dir)
    return DataLoaderRainTrain(rgb_dir, img_options)

def get_validation_rain_data(rgb_dir, img_options):
    assert os.path.exists(rgb_dir)
    return DataLoaderRainVal(rgb_dir, img_options)
